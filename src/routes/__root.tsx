  ...
  head: () => ({
    meta: [
      ...
      { title: "Orange Gesture Control" },
      {
        name: "description",
        content:
          "Site officiel d'Orange Gesture Control — extension Firefox de navigation par gestes de souris.",
      },
      { name: "author", content: "Orange Labs" },
      { property: "og:title", content: "Orange Gesture Control" },
      {
        property: "og:description",
        content:
          "Naviguez sur le web avec des gestes de souris. Téléchargez l'extension Firefox modernisée.",
      },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "(function(){try{var t=localStorage.getItem('ogc-theme');if(!t){t=window.matchMedia&&window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light';}if(t==='dark'){document.documentElement.classList.add('dark');}}catch(e){}})();",
          }}
        />
      </head>
      <body>
